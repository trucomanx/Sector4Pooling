...
class Sector4Pooling2D(Layer):
    ...
    def build(self,input_shape):
        ...
        self.Dim1=int(math.ceil(input_shape[1]/2.0));
        self.Dim2=int(math.ceil(input_shape[2]/2.0));
    ...
    def compute_output_shape(self,input_shape):
        Dim1=int(math.ceil(input_shape[1]/2.0));
        Dim2=int(math.ceil(input_shape[2]/2.0));
...
model = Sequential([
    Sector4Pooling2D(input_shape=input_shape)
])
